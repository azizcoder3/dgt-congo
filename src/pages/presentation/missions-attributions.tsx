...
const MissionItem = ({ children }: { children: React.ReactNode }) => (
    <li className="flex items-start p-4 bg-gradient-to-r from-green-50 to-white rounded-xl shadow-sm border border-green-100 hover:shadow-md transition-shadow duration-300 group">
        <div className="flex-shrink-0 w-8 h-8 bg-yellow-100 rounded-full flex items-center justify-center mr-4 mt-0.5 group-hover:bg-yellow-200 transition-colors duration-200">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <main className="flex-grow">
        ...
        <section className="relative h-80 bg-gradient-to-br from-green-800 to-green-900 text-white overflow-hidden">
          ...
          <div className="relative z-20 container mx-auto px-6 h-full flex flex-col justify-center">
            <div className="max-w-4xl">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">Attributions et Organisation</h1>
        ...
        <div className="container mx-auto px-6 py-16 lg:py-20">
            <div className="max-w-5xl mx-auto">
                ...
                <section className="mb-16 lg:mb-20">
                  <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 lg:p-10">
                    <div className="flex items-center mb-6">
                      ...
                      <h2 className="text-3xl lg:text-4xl font-bold text-gray-800">Le Trésor Public Congolais</h2>
                    </div>
                    <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                      <p className="text-lg lg:text-xl">
                        ...
                        dans l&apos;exercice de ses attributions en matière de gestion de la trésorerie et d&apos;exécution comptable du budget de l&apos;État, 
                        des collectivités locales et des autres organismes publics soumis aux règles de la comptabilité publique.
                      </p>
                    </div>
                  </div>
                </section>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-lg border border-blue-100 p-8 lg:p-10">
                    ...
                    <div className="space-y-6 p-6 bg-white/80 rounded-xl border border-white backdrop-blur-sm">
                      <p className="text-lg text-gray-700 leading-relaxed">
                        La Direction Générale du Trésor est dirigée par un <strong className="text-green-600">Directeur Général</strong>, 
                        assisté par un <strong className="text-green-600">Directeur Général Adjoint</strong>, tous deux nommés par décret en Conseil des ministres.
                      </p>
                ...
                <section className="mt-16 lg:mt-20">
                  <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-8 lg:p-10 text-center text-white shadow-xl">
