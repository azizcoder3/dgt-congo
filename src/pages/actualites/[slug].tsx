...
//         {/* On utilise une grille pour créer deux colonnes */}
//         <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
...
//                 <Image src={article.imageUrl} alt={`Image pour l'article : ${article.title}`} layout="fill" objectFit="cover" />
//               </div>
//             )}
...
//   // AJOUT : On récupère tous les articles, puis on filtre
//   const allArticles = await getAllNews();
//   const recentArticles = allArticles
//     .filter(a => a.slug !== slug) // On exclut l'article actuel
//     .slice(0, 4); // On ne garde que les 4 plus récents
...
//     props: {
//       article: JSON.parse(JSON.stringify(article)),
//       recentArticles: JSON.parse(JSON.stringify(recentArticles)), // On passe les articles récents
//       categories: JSON.parse(JSON.stringify(categories)),
//     },
//     revalidate: 60,
//   };
