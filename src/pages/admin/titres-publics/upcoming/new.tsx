// src/pages/admin/titres-publics/upcoming/new.tsx
...
const NewUpcomingAuctionPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      <Head>
        <title>Nouvelle Émission | Administration</title>
      </Head>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h1 className="text-2xl font-bold text-white">Ajouter une Émission à Venir</h1>
...
export default NewUpcomingAuctionPage;