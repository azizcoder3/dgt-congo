...
// // src/pages/admin/institutionnel/index.tsx
...
//             <Head><title>Gestion Institutionnelle | Administration</title></Head>
            
//             <header className="bg-white shadow-sm">
//                 <div className="container mx-auto px-6 py-4 flex justify-between items-center">
//                     <div>
//                         <h1 className="text-xl font-bold">Gestion Institutionnelle</h1>
...
//                     {/* Carte pour le Ministre */}
//                     <Link href="/admin/institutionnel/ministre" className="block p-6 bg-white rounded-lg shadow-md border hover:border-blue-500 hover:shadow-lg transition">
//                         <h3 className="text-lg font-bold">Le Mot du Ministre</h3>
//                         <p className="mt-1 text-sm text-gray-600">Modifier le nom, le titre, la biographie et la photo du Ministre.</p>
//                     </Link>
                    
//                     {/* Carte pour l'Équipe de Direction */}
//                     <Link href="/admin/institutionnel/direction" className="block p-6 bg-white rounded-lg shadow-md border hover:border-blue-500 hover:shadow-lg transition">
//                         <h3 className="text-lg font-bold">Équipe de Direction (DG & DGA)</h3>
//                         <p className="mt-1 text-sm text-gray-600">Mettre à jour les informations du Directeur Général et de son Adjoint.</p>
//                     </Link>
                    
//                     {/* Carte pour les Directeurs Centraux */}
//                     <Link href="/admin/directorates" className="block p-6 bg-white rounded-lg shadow-md border hover:border-blue-500 hover:shadow-lg transition">
//                         <h3 className="text-lg font-bold">Directeurs Centraux</h3>
//                         <p className="mt-1 text-sm text-gray-600">Gérer la liste des directions centrales.</p>
//                     </Link>

//                     {/* Carte pour l'Organigramme */}
//                     <Link href="/admin/institutionnel/organigramme" className="block p-6 bg-white rounded-lg shadow-md border hover:border-blue-500 hover:shadow-lg transition">
//                         <h3 className="text-lg font-bold">Organigramme</h3>
//                         <p className="mt-1 text-sm text-gray-600">Changer l&apos;image de l&apos;organigramme officiel.</p>
//                     </Link>
//                 </div>
//             </main>
//         </div>
