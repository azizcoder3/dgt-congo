// src/components/HeroSlider.tsx (CODE MODIFIÉ)
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={slide.id}>
            <div className="relative h-full w-full">
              ...
              {/* SUPPRIMÉ: Les dégradés d'origine */}
              ...
              <div className="absolute inset-0 z-10 flex flex-col justify-center items-start px-12 sm:px-16 lg:px-24 xl:px-32">
                <div className="max-w-2xl lg:max-w-3xl xl:max-w-4xl space-y-6">
                  ...
                  {slide.date && (
                    <div className="inline-flex items-center px-4 py-2 bg-black/30 backdrop-blur-sm rounded-full border border-white/30">
                  ...
                  {/* Titre principal avec arrière-plan noir transparent */}
